// A program to find the index of the largest integer using recursion
 ...
 * @retval
 */
unsigned short maxNumberIndex(short *, unsigned short, unsigned short);
...
void main()
{
    ...
    printf("\nIndex of the largest integer is %hu", maxNumberIndex(array_num, n - 1, 0));
...
unsigned short maxNumberIndex(short array[], unsigned short n, unsigned short index)
{
    if (index == n)
    {
        return index;
    ...
    unsigned short i = maxNumberIndex(array, n, index + 1);

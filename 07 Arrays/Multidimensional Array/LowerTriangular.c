// A program to convert a matrix in Lower triangular form
...
void displayLowerTriangularMatrix(int **, unsigned short, unsigned short);
...
void main()
{
    ...
    displayLowerTriangularMatrix(matrix, nRows, nColumns);
...
void displayLowerTriangularMatrix(int **matrix, unsigned short nRows, unsigned short nColumns)
{
    if(nRows != nColumns)
    {
        printf("\nNot a Square Matrix");
